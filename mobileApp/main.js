...
const uWin = new Audio("./assets/Sounds/uWin.mp3");
const uLose = new Audio("./assets/Sounds/uLoseAlt.mp3");
const uHit = new Audio("./assets/Sounds/uHit.mp3");
const cHit = new Audio("./assets/Sounds/cHit.mp3");
